...
void mode_kaleidoscope_plasma()
{
    ...
    {
        timer1.setPeriod(100 - map(kaleidoscope_speed, KALEIDOSCOPE_MIN_SPEED, KALEIDOSCOPE_MAX_SPEED, 0, 100));
    ...
    {
        timer2.setPeriod(200 - map(kaleidoscope_speed, KALEIDOSCOPE_MIN_SPEED, KALEIDOSCOPE_MAX_SPEED, 0, 200));
